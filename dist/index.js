...
document.addEventListener("DOMContentLoaded", () => {
    ...
    searchInput.addEventListener('input', debounce(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (searchInput.value === "")
            return;
        const query = encodeURIComponent(searchInput.value); //кодируется     значение из поля поиска для безопасного включения его в URL.
        ...
        results.forEach((item) => {
            ...
            elem.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
                if (!item.fromHistory) {
                    searchHistory.push(item.name); //добавляется выбранный элемент в историю поиска, сохраняется обновленная история в локальное хранилище
